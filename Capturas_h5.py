...
def Separar_Canales(pdata_16bit, total_number_of_channels,
    ...
    for i in range(0, total_number_of_channels, channels_per_pixel):
        ...
        if inicio_z < z < inicio_z + rango_z:
            x = pdata_16bit[i]
            y = pdata_16bit[i + 1]
            coor = x, y, z
            xyz.append(coor)
...
def Iniciar(label):
    ...
    with device.start_stream():
        with h5py.File('Capturas/' + label + '.h5', 'w') as hdf:
            while True:
                ...
                plt.show(PointCloud, num_frame, bg='white',
...
if __name__ == '__main__':
    ...
    print("Escriba el nombre de la prueba a realizar:")
